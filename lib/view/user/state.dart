...
abstract class _State extends StateAbstract<Main> {
  ...
  void _launchAppCode() {
    Launcher.universalLink('https://github.com/laisiangtho/dictionary');
  }

  void _launchPrivacy() {
    Launcher.universalLink('https://github.com/laisiangtho/dictionary/blob/master/PRIVACY.md');
  }

  void _launchAppIssues() {
    Launcher.universalLink('https://github.com/laisiangtho/dictionary/issues/new');
  }
}
